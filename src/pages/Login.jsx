    ...
    <main className="min-h-screen flex justify-center items-center my-6">
      <section className="flex flex-col items-center">
        ...
        <div className="text-center">
          <h3 className="font-normal text-2xl mt-6">Welcome Back</h3>
        </div>
        <div className="text-center">
        ...
        <p className="text-sm text-gray-500 text-center mt-3">Don't have an account? <span className="text-blue-600">Sign up</span></p>
      </section>
    </main>
  );
};
